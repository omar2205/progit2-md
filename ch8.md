...
This script uses a syntax that wasn’t covered in [Revision Selection](https://git-scm.com/book/en/v2/ch00/_revision_selection). You get a list of commits that have already been pushed up by running this:
